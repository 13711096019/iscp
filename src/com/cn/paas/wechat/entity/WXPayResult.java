...
public class WXPayResult {
	...
	private String device_info;//(-1)device_info,,微信支付分配的终端设备号，
	...
	private String fee_type;//(-1)货币种类，符合ISO4217标准的三位字母代码，默认人民币：CNY
	private int cash_fee;//实际支付：现金支付金额订单现金支付金额
	private String cash_fee_type;//(-1)货币类型，符合ISO4217标准的三位字母代码，默认人民币：CNY
