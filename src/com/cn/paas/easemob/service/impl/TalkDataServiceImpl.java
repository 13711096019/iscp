...
import com.cn.paas.easemob.tool._Const;
import com.cn.paas.easemob.tool._Global;
...
public class TalkDataServiceImpl implements TalkDataService {
	...
	public TalkNode logout(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username
				...
				_Const.DATA_GROUP_FRIEND);
	}

	public TalkNode userSave(String username, String password, String nickname)
			throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("username", username);
		param.put("password", password);
	...
	public TalkNode userSave(String[] username, String[] password,
	...
	public TalkNode userModifyAccess(String username, Boolean access)
			throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/"
	...
	public TalkNode userModifyPassword(String username, String password)
			throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
	...
	public TalkNode userModifyNickname(String username, String nickname)
			throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("nickname", nickname);
		return service.request(_Global.URL_USER + "/" + username,
	...
	public TalkNode userList(Long size, String cursor, Long start)
			throws Exception {
	...
	public TalkNode userMessageLine(String username, String id)
			throws Exception {
		return service.request(_Global.URL_USER + "/" + username
				+ "/offline_msg_status/" + id, _Global.HTTP_METHOD_GET, null,
				auth, _Const.DATA_MAP);
	}
	...
	public TalkNode blockSave(String username, String[] friend)
			throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
	...
	public TalkNode groupSave(String owner, String name, String desc,
		...
		return service.request(_Global.URL_GROUP, _Global.HTTP_METHOD_POST,
				param, auth, _Const.DATA_GROUP);
	}

	public TalkNode groupDrop(String id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id,
				_Global.HTTP_METHOD_DELETE, null, auth, _Const.DATA_GROUP);
	}

	public TalkNode groupModify(String id, String name, String desc,
		...
		param.put("maxusers", limit);
		return service.request(_Global.URL_GROUP + "/" + id,
				_Global.HTTP_METHOD_PUT, param, auth, _Const.DATA_GROUP_UPDATE);
	}
	...
	public TalkNode groupModifyOwner(String id, String owner) throws Exception {
		...
		return service.request(_Global.URL_GROUP + "/" + id,
				_Global.HTTP_METHOD_PUT, param, auth, _Const.DATA_GROUP_OWNER);
	}

	public TalkNode groupGet(String[] id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + this.param(id),
				_Global.HTTP_METHOD_GET, null, auth, _Const.DATA_GROUP_LIST_NEW);
	}

	public TalkNode groupList(Long size, String cursor, Long start)
			throws Exception {
		return service.request(
				_Global.URL_GROUP + "?" + this.page(size, cursor, start),
				_Global.HTTP_METHOD_GET, null, auth, _Const.DATA_GROUP_LIST);
	}
	...
	public TalkNode groupFriendSave(String id, String[] friend)
			throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("usernames", friend);
		return service.request(_Global.URL_GROUP + "/" + id + "/users",
				_Global.HTTP_METHOD_POST, param, auth, _Const.DATA_GROUP_FRIEND);
	}
	...
	public TalkNode groupBlackList(String id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/blocks/users",
				_Global.HTTP_METHOD_GET, null, auth, _Const.DATA_ARRAY);
	}

	public TalkNode fileUpload(File file) throws Exception {
		return service
				.upload(_Global.URL_FILE, file, auth, _Const.DATA_ENTITIES);
	}
	...
	public TalkNode messageSave(TalkMsg data) throws Exception {
		...
		return service.request(_Global.URL_MESSAGES, _Global.HTTP_METHOD_POST,
				param, auth, _Const.DATA_MAP);
	}

	public TalkNode messageList(Long size, String cursor, Long start)
			throws Exception {
		return service.request(
	...
	public TalkNode chatList(Long size, String cursor, Long start)
			throws Exception {
		return service.request(_Global.URL_CHAT + "?" + this.timestamp(start),
				_Global.HTTP_METHOD_GET, null, auth, _Const.DATA_CHAT_LIST);
		// return
		// service.request(_Global.URL_CHAT+"?"+this.page(size,cursor,start),_Global.HTTP_METHOD_GET,null,auth,TalkNode.DATA_CHAT_LIST);
	}

	public TalkNode roomSave(String owner, String name, String desc,
			Integer limit, String[] friend) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("name", name);
		param.put("description", desc);
		...
		return service.request(_Global.URL_ROOM, _Global.HTTP_METHOD_POST,
				param, auth, _Const.DATA_ROOM);
	}

	public TalkNode roomModify(String id, String name, String desc,
			Integer limit) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("name", name);
		param.put("description", desc);
	...
	public TalkNode roomFriendSave(String id, String[] friend) throws Exception {
		...
		return service.request(_Global.URL_ROOM + "/" + id + "/users",
				_Global.HTTP_METHOD_POST, param, auth, _Const.DATA_ROOM_REDO);
	}
	...
	private String timestamp(Long start) throws Exception {
		StringBuffer res = new StringBuffer();
		if (start != null) {
			res.append("select * where timestamp > " + start);
		}
		return "ql=" + URLEncoder.encode(res.toString(), "UTF-8");
	}
}